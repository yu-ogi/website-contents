...
var CollapsingE = /** @class */ (function (_super) {
    ...
    CollapsingE.prototype.place = function (ui, addContents) {
        ...
        ui.popPlacer();
        ui.popWidget();
        (0, collision_js_1.enlargeAABB)(bounds, new collision_js_1.Vec2(placer.bounds.min).add(this));
        (0, collision_js_1.enlargeAABB)(bounds, new collision_js_1.Vec2(placer.bounds.max).add(this));
    ...
    CollapsingE.prototype.renderSelf = function (renderer, _camera) {
        (0, common_1.drawText)(renderer, this.font, "".concat(this.isOpen ? "▼" : "▶︎", " ").concat(this.title), 0, 0);
