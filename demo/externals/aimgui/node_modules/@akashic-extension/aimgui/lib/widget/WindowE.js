...
var WindowE = /** @class */ (function (_super) {
    ...
    WindowE.prototype.drawTitleBar = function (renderer) {
        ...
        // タイトル。
        (0, common_1.drawText)(renderer, this.font, (0, common_1.limitText)(this.font, this.title, this.width - this.margin * 2, ""), this.margin, 0);
    };
    ...
    WindowE.prototype.handlePointDown = function (ev) {
        if (ev.point.y < this.titleBarHeight) {
            ...
            else if (this.resizable && (0, collision_js_1.aabbToVec)(this.getResizeAABB(), ev.point)) {
