...
var ScrollBar = /** @class */ (function () {
    ...
    ScrollBar.prototype.intersectThumb = function (scrollArea, pos) {
        var shape = this.getShape(scrollArea);
        return shape != null && (0, collision_js_1.aabbToVec)(shape.thumb, pos);
    };
    /**
    ...
    ScrollBar.prototype.intersectBar = function (scrollArea, pos) {
        var shape = this.getShape(scrollArea);
        return shape != null && (0, collision_js_1.aabbToVec)(shape.bar, pos);
    };
    /**
     * スクロールバーの形状の取得。
     *
    ...
    ScrollBar.prototype.getShape = function (scrollArea) {
        ...
        return {
            ...
            addScroll: function (dy) { return (0, collision_js_1.clamp)(dy / (vScrollBarH - thumbH) + (scrollY / maxScrollY), 0, 1) * maxScrollY; }
        };
    };
    /**
     * スクロールバーの描画。
