(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.g = factory());
	...
	var TriggerLike = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(TriggerLike);

	var ChainTriggerLike = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(ChainTriggerLike);
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar(TriggerLike, exports);
	__exportStar(ChainTriggerLike, exports);
	__exportStar(Trigger_1, exports);
	__exportStar(ChainTrigger_1, exports);
	});
	...
	CompositeOperation_1.CompositeOperation;
	...
	var VectorImageAsset = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(VectorImageAsset);

	var VectorImageAssetHint = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(VectorImageAssetHint);
	...
	AssetLoadErrorType_1.AssetLoadErrorType;
	...
	ExceptionFactory_1.ExceptionFactory;
	...
	AudioSystem_1.SoundAudioSystem;
	AudioSystem_1.MusicAudioSystem;
	AudioSystem_1.AudioSystem;
	...
	var E = /** @class */ (function (_super) {
	    ...
	    Object.defineProperty(E.prototype, "onUpdate", {
	        ...
	        get: function () {
	            if (!this._onUpdate)
	                this._onUpdate = new lib$2.ChainTrigger(this.scene.onUpdate);
	    ...
	    Object.defineProperty(E.prototype, "onMessage", {
	        ...
	        get: function () {
	            if (!this._onMessage)
	                this._onMessage = new lib$2.ChainTrigger(this.scene.onMessage);
	    ...
	    Object.defineProperty(E.prototype, "onPointDown", {
	        ...
	        get: function () {
	            if (!this._onPointDown)
	                this._onPointDown = new lib$2.ChainTrigger(this.scene.onPointDownCapture, this._isTargetOperation, this);
	    ...
	    Object.defineProperty(E.prototype, "onPointUp", {
	        ...
	        get: function () {
	            if (!this._onPointUp)
	                this._onPointUp = new lib$2.ChainTrigger(this.scene.onPointUpCapture, this._isTargetOperation, this);
	    ...
	    Object.defineProperty(E.prototype, "onPointMove", {
	        ...
	        get: function () {
	            if (!this._onPointMove)
	                this._onPointMove = new lib$2.ChainTrigger(this.scene.onPointMoveCapture, this._isTargetOperation, this);
	...
	var FrameSprite = /** @class */ (function (_super) {
	    ...
	    function FrameSprite(param) {
	        ...
	        _this.onFinish = new lib$2.Trigger();
	...
	var EmptyVectorImageAsset_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var EmptyVectorImageAsset = /** @class */ (function () {
	    function EmptyVectorImageAsset(id, path, width, height, hint) {
	        ...
	        this.width = 0;
	        this.height = 0;
	        this.onDestroyed = new lib$2.Trigger();
	        this.id = id;
	        this.path = path;
	...
	unwrapExports(EmptyVectorImageAsset_1);
	EmptyVectorImageAsset_1.EmptyVectorImageAsset;

	var PartialImageAsset_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	unwrapExports(PartialImageAsset_1);
	PartialImageAsset_1.PartialImageAsset;
	...
	AudioSystemManager_1.AudioSystemManager;
	...
	var CameraCancellingE_1 = createCommonjsModule(function (module, exports) {
	var __extends = (commonjsGlobal && commonjsGlobal.__extends) || (function () {
	    var extendStatics = function (d, b) {
	        extendStatics = Object.setPrototypeOf ||
	            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
	...
	unwrapExports(CameraCancellingE_1);
	CameraCancellingE_1.CameraCancellingE;
	...
	var Timer = /** @class */ (function () {
	    function Timer(interval, fps) {
	        ...
	        this.onElapse = new lib$2.Trigger();
	...
	TimerManager_1.TimerIdentifier;
	...
	var Scene = /** @class */ (function () {
	    ...
	    function Scene(param) {
	        ...
	        this.onLoad = new lib$2.Trigger();
	        this.loaded = this.onLoad;
	        this._onReady = new lib$2.Trigger();
	        ...
	        this.onUpdate = new lib$2.Trigger();
	        this.update = this.onUpdate;
	        this._timer = new TimerManager_1.TimerManager(this.onUpdate, this.game.fps);
	        this.onAssetLoad = new lib$2.Trigger();
	        this.onAssetLoadFailure = new lib$2.Trigger();
	        this.onAssetLoadComplete = new lib$2.Trigger();
	        ...
	        this.onMessage = new lib$2.Trigger();
	        this.onPointDownCapture = new lib$2.Trigger();
	        this.onPointMoveCapture = new lib$2.Trigger();
	        this.onPointUpCapture = new lib$2.Trigger();
	        this.onOperation = new lib$2.Trigger();
	        ...
	        this.children = [];
	        this.state = "standby";
	        this.onStateChange = new lib$2.Trigger();
	        this._assetHolders = [];
	...
	var LoadingScene = /** @class */ (function (_super) {
	    ...
	    function LoadingScene(param) {
	        ...
	        _this.onTargetReset = new lib$2.Trigger();
	        _this.onTargetReady = new lib$2.Trigger();
	        _this.onTargetAssetLoad = new lib$2.Trigger();
	...
	DefaultLoadingScene_1.DefaultLoadingScene;

	var DefaultSkippingScene_1 = createCommonjsModule(function (module, exports) {
	var __extends = (commonjsGlobal && commonjsGlobal.__extends) || (function () {
	    var extendStatics = function (d, b) {
	        extendStatics = Object.setPrototypeOf ||
	            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
	...
	unwrapExports(DefaultSkippingScene_1);
	DefaultSkippingScene_1.DefaultSkippingScene;
	...
	SurfaceAtlasSlot_1.SurfaceAtlasSlot;
	...
	SurfaceAtlasSet_1.SurfaceAtlasSet;
	...
	Storage_1.Storage;
	Storage_1.StorageLoader;
	Storage_1.StorageValueStore;
	Storage_1.StorageCountsOperation;
	Storage_1.StorageCondition;
	Storage_1.StorageOrder;
	Storage_1.StorageRegion;
	    ...
	    EventConverter.prototype.toGameEvent = function (pev) {
	        ...
	        switch (eventCode) {
	            ...
	            case 32 /* pl.EventCode.Message */:
	                ...
	                return new Event.MessageEvent(pev[3 /* EventIndex.Message.Message */], player, local, prio);
	            case 33 /* pl.EventCode.PointDown */:
	                local = pev[7 /* EventIndex.PointDown.Local */];
	...
	EventConverter_1.EventConverter;
	...
	var InternalOperationPluginInfo = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(InternalOperationPluginInfo);
	...
	RequireCachedValue_1.RequireCachedValue;
	...
	ScriptAssetContext_1.ScriptAssetContext;
	...
	NinePatchSurfaceEffector_1.NinePatchSurfaceEffector;
	...
	var OperationPluginManager = /** @class */ (function () {
	    function OperationPluginManager(game, viewInfo) {
	        this.onOperate = new lib$2.Trigger();
	...
	OperationPluginManager_1.OperationPluginManager;
	...
	PointEventResolver_1.PointEventResolver;
	...
	var SnapshotSaveRequest = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	});

	unwrapExports(SnapshotSaveRequest);
	...
	XorshiftRandomGenerator_1.XorshiftRandomGenerator;
	...
	var Game = /** @class */ (function () {
	    ...
	    function Game(param) {
	        ...
	        this.onJoin = new lib$2.Trigger();
	        this.onLeave = new lib$2.Trigger();
	        this.onPlayerInfo = new lib$2.Trigger();
	        this.onSeed = new lib$2.Trigger();
	        ...
	        this.onResized = new lib$2.Trigger();
	        this.onSkipChange = new lib$2.Trigger();
	        ...
	        this._onLoad = new lib$2.Trigger();
	        this._onStart = new lib$2.Trigger();
	        this._loaded = this._onLoad;
	        this._started = this._onStart;
	        this.isLoaded = false;
	        this.onSnapshotRequest = new lib$2.Trigger();
	        ...
	        this._onOperationPluginOperated = new lib$2.Trigger();
	        ...
	        this.onSceneChange = new lib$2.Trigger();
	        this._onSceneChange = new lib$2.Trigger();
	...
	__exportStar(AssetHolder_1, exports);
	...
	__exportStar(DefaultSkippingScene_1, exports);
	...
	index_common.VideoSystem;
	index_common.ShaderProgram;
	index_common.Module;
	index_common.AudioSystem;
